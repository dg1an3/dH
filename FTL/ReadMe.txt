========================================================================
    STATIC LIBRARY : FTL Project Overview
========================================================================

AppWizard has created this FTL library project for you. 

This file contains a summary of what you will find in each of the files that
make up your FTL application.
...
StdAfx.h, StdAfx.cpp
    ...
    named FTL.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "FTL.rc" and a "FTL.h" that 
