...
! ********** external function references *************************************
        ...
        real density(-50:50,-50:50,1:101)
...
! ********** local variables **************************************************
        ...
        real homdens,hetdens,breast_radius,xoffset,zoffset,indens
        real x_min,x_max,z_min,z_max,hethick,weightx,weightz
        real posplane,cyl_radius,cyl_length,cyl_inrad
...
c Done for a cylidrical phantom perpendicular to the beam direction.
        ...
        if (hetstate .eq. 7) then
         ...
         read*,cyl_length               
         print*,' '        
         print*,'Enter the offset of the center of the phantom in x-d'
         print*,'Negative or positive values are valid.'       
         read*,xoffset
         print*,' '
         print*,'Enter the offset of the center of the phantom in z-d'
         print*,'Negative or positive values are valid.'       
         read*,zoffset
         print*,' '                             
...
c          call time(now)           
     ...
     1                   -50,                !min. integer in x-dir
     1                   50,                 !max. integer in x-dir
     1                   1,                  !min. integer in z-dir
     1                   101,                !max. integer in z-dir
     ...
     1              filename_out
          ...
          write(2) (((density(i,j,k),i=-50,50),j=-50,50),k=1,101)
