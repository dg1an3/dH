...
//
// Key algorithm: ClipRaster() performs ray-volume intersection clipping
// using fixed-point arithmetic (16.16 format) for performance.
//
//////////////////////////////////////////////////////////////////////
...
//		ASSERT(nDest Length == nDestLength2);
